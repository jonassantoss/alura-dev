...
export function ExportButton() {
  ...
  function getSelectedSize() {
    const selectedSize = sizeButtons.filter((button) => button.selected)[0]
      .value;
  ...
  function getSelectedType() {
    const selectedType = imageButtons.filter((button) => button.selected)[0]
      .value;
    ...
    <div className="flex w-full md:w-1/2">
      ...
      <Popover.Root>
        <Popover.Trigger asChild>
          <button
            type="button"
            className="w-1/5 flex justify-center items-center box-border border-transparent border-4 border-l-2 border-l-slate-800/40 bg-slate-100 text-blue-950 text-center p-1 rounded-r-lg duration-300 md:w-1/6 lg:w-1/4 hover:bg-slate-300 active:bg-slate-400">
            <ChevronDownIcon />
          </button>
        </Popover.Trigger>
        <Popover.Portal>
            ...
            <div className="flex flex-col space-y-2 bg-slate-100 text-blue-950 p-2 rounded-md shadow-alura">
              ...
              <div className="border-b-[1px] w-full border-b-slate-800/40 pb-1">
                <div className="flex items-center justify-between text-xs">
                  <p className="w-1/2 ml-2">Tamanho</p>
              ...
              <div className="border-b-[1px] w-full border-b-slate-800/40 pb-1">
                <div className="flex items-center justify-between text-xs">
                  <p className="text-xs w-1/2 ml-2">Tipo da imagem</p>
